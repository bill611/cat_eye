...
#define MSG_MAINWIN_KEYDOWN         0x0019
#define MSG_MAINWIN_KEYUP           0x001A
#define MSG_MAINWIN_KEYLONGPRESS    0x001B
#define MSG_MAINWIN_KEYALWAYSPRESS  0x001C
#define MSG_MAINWIN_KEYUP_LONG      0x001D

#define MSG_KEYUP_LONG    0x001E
...
#define MSG_MENUBARPAINT       0x00B5
...
/* Group 7 from 0x00F0 to 0x0111, Internal window management messages. */
...
#define MSG_HIDEMENUBAR     0x010F

#define MSG_HIDESUBMENU        0x0110

#define MSG_LASTWINDOWMSG   0x0111
...
MG_EXPORT BOOL GUIAPI PeekMessageEx (PMSG pMsg, HWND hWnd, 
                int iMsgFilterMin, int iMsgFilterMax, 
                BOOL bWait, UINT uRemoveMsg);
MG_EXPORT int GUIAPI DestroyAllMenu(void);
/**
...
#define WS_WITHOUTCLOSEMENU   0x00002000L

#define WS_HIDEMENUBAR      0x00001000L
...
#define WE_MENU                     1
#define WE_SUBMENU                  2
#define WE_MESSAGEBOX               3
#define WE_TOOLTIP                  4
#define WE_WND_BORDER               5
#define WE_SCROLLBAR                6
#define WE_INACTIVE_CAPTION         7
#define WE_WINDOW                   8
#define WE_THREED_BODY              9
#define WE_SELECTED_ITEM            10
#define WE_DISABLED_ITEM            11
#define WE_HIGHLIGHT_ITEM           12
#define WE_SIGNIFICANT_ITEM         13
#define WE_DESKTOP                  14
...
/* Sub Menu */
#define WE_FONT_SUBMENU                (WE_SUBMENU | WE_ATTR_TYPE_FONT)
#define WE_METRICS_SUBMENU             (WE_SUBMENU | WE_ATTR_TYPE_METRICS)
#define WE_FGC_SUBMENU                 (WE_SUBMENU | WE_ATTR_TYPE_FGC)
#define WE_BGC_SUBMENU                 (WE_SUBMENU | WE_ATTR_TYPE_BGCA)
#define WE_TGC_SUBMENU                 (WE_SUBMENU | WE_ATTR_TYPE_BGCB)
...
MG_EXPORT BOOL GUIAPI DestroyMainWindowMenu (HWND hWnd);
MG_EXPORT BOOL GUIAPI CreateMainWindowMenu (HWND hWnd, HMENU hmnu);
MG_EXPORT BOOL GUIAPI SetSystemLanguage (HWND hWnd, int language);
 ...
 */
MG_EXPORT HWND GUIAPI GetMessageHwnd(void);
