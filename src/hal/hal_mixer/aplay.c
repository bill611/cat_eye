...
static int aplay(int sample,int channel,int bit)
{
	...
	chunk_size = 1024;
	rhwparams.rate = sample;
	rhwparams.channels = channel;
	rhwparams.format = file_type = SND_PCM_FORMAT_S16_LE;
 ...
 */
static size_t mystrftime(char *s, size_t max, const char *userformat,
